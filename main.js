...
(function(){
  var bodyParser, serveStatic, join$ = [].join;
  ...
  this.include = function(){
    ...
    this.app.use('/edit', serveStatic(__dirname));
    this.app.use('/view', serveStatic(__dirname));
    this.app.use('/app', serveStatic(__dirname));
    ...
    this.get({
      '/zappajs-client.js': sendFile('node_modules/zappajs-client/browser.js')
    });
    this.get({
    ...
    return this.use(serveStatic(__dirname));
    function fn$(){
